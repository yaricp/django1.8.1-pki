...
PKI_DEFAULT_OU = getattr(settings, 'PKI_DEFAULT_OU', 'LAN1')
PKI_DEFAULT_STATE = getattr(settings, 'PKI_DEFAULT_STATE','Ya')
PKI_DEFAULT_LOCALITY = getattr(settings, 'PKI_DEFAULT_LOCALITY', 'Ya')
PKI_DEFAULT_VALID_DAYS = getattr(settings, 'PKI_DEFAULT_VALID_DAYS', 1825)
PKI_DEFAULT_EMAIL = getattr(settings, 'PKI_DEFAULT_EMAIL', 'test@test.ru')
