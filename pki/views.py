...
def admin_history(request, model, id):
    ...
    return render(
        ...
        {
            'changelogs': changelogs, 'title': "Change history: %s" % obj.common_name,
...
def admin_delete(request, model, id):
    ...
    return render('admin/pki/delete_confirmation.html', { 'deleted_objects': deleted_objects, 'object_name': opts.verbose_name,
